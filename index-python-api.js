...
async function executeITermPythonScript(scriptContent) {
...
server.registerTool("split-terminal-vertical", {
...
server.registerTool("execute-command-in-pane", {
...
server.registerTool("get-session-details", {
...
server.registerTool("list-all-sessions", {
...
server.registerTool("monitor-session", {
...
server.registerTool("list-panes", {
...
server.registerTool("get-terminal-state", {
